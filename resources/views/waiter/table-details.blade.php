                    ...
                    <div class="card-body">
                        <div class="table-info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div class="value">
                                    {{ $table->occupied_at ? $table->occupied_at->diffForHumans(null, true) : '-' }}</div>
                            ...
                            @foreach ($orders as $order)
                                <div class="order-card">
                                    <div class="order-card-header">
                                        ...
                                        <div class="text-end">
                                            <span
                                                class="badge bg-{{ in_array($order->status, ['Aguardando pagamento', 'Aguardando produção'])
                                                    ? 'warning'
                                    ...
                                    @if ($order->notes)
                                        <div class="alert alert-warning mt-3 mb-0">
                                            <strong><i class="fas fa-sticky-note me-1"></i>Obs:</strong>
                                            {{ $order->notes }}
                                        </div>
                                    @endif
