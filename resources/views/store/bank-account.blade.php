            ...
            <div class="col-12">
                ...
                <form action="{{ route('store.bank-account.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="pix_key_type" name="pix_key_type">
                                        ...
                                        <option value="cpf"
                                            {{ old('pix_key_type', $bankAccount->pix_key_type ?? '') == 'cpf' ? 'selected' : '' }}>
                                            CPF</option>
                                        <option value="cnpj"
                                            {{ old('pix_key_type', $bankAccount->pix_key_type ?? '') == 'cnpj' ? 'selected' : '' }}>
                                            CNPJ</option>
                                        <option value="email"
                                            {{ old('pix_key_type', $bankAccount->pix_key_type ?? '') == 'email' ? 'selected' : '' }}>
                                            E-mail</option>
                                        <option value="phone"
                                            {{ old('pix_key_type', $bankAccount->pix_key_type ?? '') == 'phone' ? 'selected' : '' }}>
                                            Telefone</option>
                                        <option value="random"
                                            {{ old('pix_key_type', $bankAccount->pix_key_type ?? '') == 'random' ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bank_code" name="bank_code"
                                        value="{{ old('bank_code', $bankAccount->bank_code ?? '') }}" placeholder="Ex: 001">
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="agency" name="agency"
                                        value="{{ old('agency', $bankAccount->agency ?? '') }}" placeholder="Ex: 1234">
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" id="account_type" name="account_type">
                                        ...
                                        <option value="checking"
                                            {{ old('account_type', $bankAccount->account_type ?? '') == 'checking' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="account_holder_document"
                    ...
                    <div class="alert alert-info">
                        <strong>Importante:</strong> Você precisa preencher pelo menos os dados PIX <strong>OU</strong> os
                        dados bancários completos. Pode preencher ambos se desejar.
                    </div>
