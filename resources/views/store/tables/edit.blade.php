...
<style>
    ...
    .edit-table-card .card-header h1 {
        color: white;
        font-weight: 700;
        margin: 0;
    }
    
    .edit-table-card .card-body {
        padding: 40px;
    }
...
<div class="container edit-table-container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card edit-table-card">
                <div class="card-header">
                    <h1 class="h4 mb-0">Editar Mesa</h1>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('store.tables.update', $table) }}" method="POST">
                        @csrf
                        @method('PUT')
