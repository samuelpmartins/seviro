                            ...
                            <tbody>
                                @foreach ($tables as $table)
                                    <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="participant-names">
                                                        @foreach ($table->participants->take(3) as $participant)
                                                            <span
                                                                class="badge bg-{{ $participant->is_owner ? 'warning' : 'info' }} me-1 mb-1">
                                                                {{ $participant->name }}
                                                        ...
                                                        @if ($table->participants->count() > 3)
                                                            <span
                                                                class="badge bg-secondary">+{{ $table->participants->count() - 3 }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            @else
                                        ...
                                        <td>
                                            <a href="{{ route('store.tables.qrcode', $table) }}"
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                @if ($table->occupied)
                                                    <form action="{{ route('store.tables.clear', $table) }}" method="POST"
                                                        class="d-inline">
                                                        @csrf
                                                ...
                                                @endif
                                                <form action="{{ route('store.tables.destroy', $table) }}" method="POST"
                                                    class="d-inline"
