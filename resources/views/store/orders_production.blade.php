...
<style>
    ...
    .btn-success:hover, .btn-link:hover {
        transform: translateY(-2px);
        box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);
    }
                        ...
                        <tbody>
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('store.orders.update-status', $order->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('PUT')
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Pedido {{ $order->order_number }} - Mesa {{ $order->table->number }}</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('store.orders.update-status', $order->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="status" value="Finalizado">
