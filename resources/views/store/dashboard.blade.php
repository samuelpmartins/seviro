...
<div class="dashboard-container">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card content-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                <div class="financial-icon me-3" style="background: rgba(255,255,255,0.2); color: white; width: 50px; height: 50px; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                    <i class="fas fa-wallet fs-4"></i>
                                </div>
                                <div>
                                    <h6 class="mb-0" style="color: rgba(255,255,255,0.8); font-size: 0.9rem;">Saldo Disponível para Saque</h6>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 text-md-end">
                            ...
                            <a href="{{ route('store.withdrawals.create') }}" class="btn btn-warning btn-lg mb-2" style="background: #fbbf24; border: none; color: #000;">
                            ...
                            <div class="financial-card h-100">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mb-0 text-success">R$ {{ number_format($todaySales, 2, ',', '.') }}</h3>
                            ...
                            <div class="financial-card h-100">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mb-0 text-primary">R$ {{ number_format($monthSales, 2, ',', '.') }}</h3>
                            ...
                            <div class="financial-card h-100">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mb-0 text-info">R$ {{ number_format($totalSales, 2, ',', '.') }}</h3>
                            ...
                            <div class="financial-card h-100">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mb-0 text-warning">R$ {{ number_format($averageTicket, 2, ',', '.') }}</h3>
                            ...
                            <div class="financial-card h-100">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="mb-0 text-danger">R$ {{ number_format($unpaidTotal, 2, ',', '.') }}</h3>
                                    ...
                                    @if($paymentMethods && $paymentMethods->count() > 0)
                                        @foreach($paymentMethods as $method)
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <span>
                                                    <i class="fas {{ $methodIcon }} text-{{ $methodColor }} me-2"></i>
                                                    {{ $methodName }}
                                                </span>
                                                <span class="badge bg-{{ $methodColor }}">
                                                    {{ $method->count }} (R$ {{ number_format($method->total, 2, ',', '.') }})
                                                </span>
                                            </div>
                                        @endforeach
                                    @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                ...
                                                <form method="POST" action="{{ route('store.orders.cancel', $order->id) }}" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Pedido {{ $order->order_number }} - {{ $order->table ? 'Mesa ' . $order->table->number : 'Balcão' }}</h5>
                                                                            ...
                                                                            <div class="d-flex justify-content-between align-items-center">
                                                                                <div>
                                                                                    ...
                                                                                    @if($item->product->is_quick_item)
                                                                                        <span class="badge bg-info ms-1" title="Item rápido - não vai para a cozinha">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="list-group">
                                                        <form method="POST" action="{{ route('store.orders.update-status', $order->id) }}" class="mb-2">
                                                            @csrf
                                                            @method('PUT')
            ...
            <div class="card content-card">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-3">
                        <button type="button" class="quick-action-btn" data-bs-toggle="modal" data-bs-target="#newProductModal">
                            <i class="fas fa-plus-circle me-2"></i> Novo Produto
                        </button>
                        <button type="button" class="quick-action-btn" data-bs-toggle="modal" data-bs-target="#newCategoryModal">
                            <i class="fas fa-folder-plus me-2"></i> Nova Categoria
                        </button>
                        <button type="button" class="quick-action-btn" data-bs-toggle="modal" data-bs-target="#newTableModal">
    ...
    fetch('{{ route("store.balance") }}')
        ...
        .then(data => {
            if (data.success) {
                ...
                balanceElement.innerHTML = 'R$ ' + balance.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
            } else {
