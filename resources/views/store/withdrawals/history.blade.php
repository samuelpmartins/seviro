                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mb-0 text-info">R$ {{ number_format($stats['total_completed'], 2, ',', '.') }}
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mb-0 text-warning">R$ {{ number_format($stats['total_pending'], 2, ',', '.') }}
                                </h4>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-danger">
                                                    ...
                                                    @if ($withdrawal->commission_percentage > 0)
                                                        <small
                                                            class="text-muted">({{ number_format($withdrawal->commission_percentage, 1) }}%)</small>
                                                    @endif
                                                </td>
                                                <td class="fw-bold">R$
                                                    {{ number_format($withdrawal->net_amount, 2, ',', '.') }}</td>
                                                <td>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Detalhes do Saque
                                                                #{{ $withdrawal->id }}</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <span
                                                                        class="badge {{ $withdrawal->statusBadgeClass }}">
                                                                        {{ $withdrawal->statusName }}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <span class="text-danger">- R$
                                                                        {{ number_format($withdrawal->commission_amount, 2, ',', '.') }}</span>
                                                                </div>
                                                                <div class="col-md-4">
                                                            ...
                                                            @if ($withdrawal->approved_at)
                                                                ...
                                                                <div class="mb-3">
                                                                    <strong>Data da
                                                                        {{ $withdrawal->isRejected() ? 'Rejeição' : 'Aprovação' }}:</strong><br>
                                                            ...
                                                            @if ($withdrawal->pix_key_used || $withdrawal->bank_data_used)
                                                                ...
                                                                @if ($withdrawal->pix_key_used)
                                                                    <p class="mb-1"><strong>PIX:</strong>
                                                                        {{ $withdrawal->pix_key_used }}</p>
                                                                @endif
                                                                @if ($withdrawal->bank_data_used)
                                                                    ...
                                                                    @if (!empty($bankData['bank_name']))
                                                                        <p class="mb-1">
                                                                            ...
                                                                            {{ $bankData['agency'] ?? '' }}<br>
                                                                            <strong>Conta:</strong>
                                                                            {{ $bankData['account_number'] ?? '' }}-{{ $bankData['account_digit'] ?? '' }}
                                                                        </p>
                                                                    @endif
                                                                @endif
                                                            @endif
