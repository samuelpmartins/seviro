                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="table_id" name="table_id">
                        ...
                        @foreach($tables as $table)
                            <option value="{{ $table->id }}" {{ request('table_id') == $table->id ? 'selected' : '' }}>Mesa {{ $table->number }}</option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach($orders as $order)
                                ...
                                <div class="modal" id="orderModal{{ $order->id }}" tabindex="-1" data-bs-backdrop="static">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <strong>Mesa:</strong> {{ $order->table ? $order->table->number : 'Balcão' }}
                                                </div>
                                                <div class="mb-3">
                                                                        ...
                                                                        <div class="d-flex justify-content-between align-items-center">
                                                                            <div>
                                                                                ...
                                                                                @if($item->product->is_quick_item)
                                                                                    <span class="badge bg-info ms-1" title="Item rápido - entrega direta pelo garçom">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.openStatusModal = function(orderId, currentStatus) {
        ...
        statuses.forEach(function(status) {
            ...
            button.type = 'submit';
            button.className = 'list-group-item list-group-item-action' + (currentStatus === status ? ' active' : '');
