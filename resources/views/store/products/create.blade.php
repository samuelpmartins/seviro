...
@section('content')
    <style>
        ...
        .create-product-card .card-header h1 {
            color: white;
            font-weight: 700;
            margin: 0;
        }
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('store.products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="ingredients-card" id="ingredients-card"
                                style="display: {{ old('customizable', false) == '1' ? 'block' : 'none' }};">
                                            ...
                                            <div class="ingredients-row ingredient-row">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="number" min="0"
                                                        ...
                                                        class="form-control" value="{{ $ingredient['amount_item'] ?? 0 }}">
                                                </div>
